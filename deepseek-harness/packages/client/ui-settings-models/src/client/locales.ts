...
export const en = {
  ...
  modelAcceptsImagesHint: 'Send attached pictures to this model instead of the vision plugin.',
  modelReasoning: 'Thinking effort',
  reasoningNone: 'Not set (no thinking)',
  reasoningCount: '{count} levels selected',
  reasoningAll: 'Select all',
  reasoningClear: 'Clear',
  reasoningOffWire: 'sends nothing',
  reasoningHint: 'Tick the thinking levels this model supports; the chat model picker will offer exactly these levels.',
  'effort.off': 'off',
  ...
  modelReasoningInvalid: 'Thinking levels must name known levels, and every level except "off" needs a wire value.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAcceptsImagesHint: '把附件图片直接发给该模型，不再走视觉插件转写。',
  modelReasoning: '思考强度',
  reasoningNone: '未设置（不思考）',
  reasoningCount: '已选 {count} 档',
  reasoningAll: '全选',
  reasoningClear: '清空',
  reasoningOffWire: '不发送参数',
  reasoningHint: '勾选该模型支持的思考强度档位，聊天界面将按此提供选择。',
  'effort.off': 'off',
  'effort.minimal': 'minimal',
  'effort.low': 'low',
  'effort.medium': 'medium',
  ...
  modelReasoningInvalid: '思考强度档位配置无效：需为已知档位，且除「关闭」外每档都要有发送值。',
