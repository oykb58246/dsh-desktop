...
describe('ModelsSection', () => {
  ...
  it('validates every adapter-owned model catalog invariant', () => {
    ...
    expect(validateDeepSeekModels([{ id: 'model', reasoningEfforts: 'low' }]))
    ...
    expect(validateDeepSeekModels([{ id: 'model', reasoningEfforts: { off: null } }]))
      .toEqual({ index: 0, key: 'modelReasoningInvalid' })
    expect(validateDeepSeekModels([{ id: 'model', reasoningEfforts: { off: null, low: '' } }]))
      .toEqual({ index: 0, key: 'modelReasoningInvalid' })
    expect(validateDeepSeekModels([{ id: 'model', reasoningEfforts: { off: null, unknown: 'x' } }]))
      .toEqual({ index: 0, key: 'modelReasoningInvalid' })
    expect(validateDeepSeekModels([{ id: 'model', reasoningEfforts: { off: 'off', low: 'low' } }]))
      .toEqual({ index: 0, key: 'modelReasoningInvalid' })
    expect(validateDeepSeekModels([{ id: 'model', reasoningEfforts: { off: null, low: 'low' } }]))
      .toBeUndefined()
  })
