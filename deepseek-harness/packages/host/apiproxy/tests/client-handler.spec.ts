...
function scriptedApi(overrides: {
  ...
  return {
    ...
    workspace: {
      list: r => ok(r, { items: [], archivedSessionIds: [], archivedWorkspaceIds: [] }),
      listArchived: r => ok(r, { workspaces: [], archivedSessionIds: [] }),
      ...
      archive: r => ok(r, { items: [], archivedSessionIds: [], archivedWorkspaceIds: [r.payload.workspaceId] }),
      unarchive: r => ok(r, { items: [], archivedSessionIds: [], archivedWorkspaceIds: [] }),
...
describe('workspace domain round trip', () => {
  it('routes both workspace methods through their handler rows and value schemas', async () => {
    ...
    expect(list.result).toEqual({ ok: true, value: { items: [], archivedSessionIds: [], archivedWorkspaceIds: [] } })
